              ...
              <div className="relative">
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-900">Available for Consultation</p>
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Upholding the highest ethical standards in all our professional dealings and client relationships.
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Putting our clients' needs first and building lasting relationships based on trust and results.
                </p>
              </div>
            </div>
          </div>
